...
export default function SchoolTab({ profile, userId }) {
  ...
  // Manual assignments (persisted via useTabData)
  ...
  const handleAddAssignment = () => {
    ...
    setAssignments((prev) => [
      ...prev,
      { id: Date.now(), title: newTitle.trim(), due: newDue || 'No date', done: false, priority: newPriority },
    ]);
    setNewTitle(''); setNewDue(''); setNewPriority('medium'); setShowAdd(false);
  };
